#!/usr/bin/env python3
"""Fit-test coupons for the clamp opening (rear wall to keybed lip, nominal 169mm).
...
ARM_LO, ARM_HI = 118.62, 138.62      # arm underside / top
...
for d in DELTAS:
    ...
    bb = c.bounding_box()
    opening = 169.0 + d
    assert len(c.solids()) == 1 and abs(bb.max.X - (179.0 + d)) < 0.01, (d, bb)
